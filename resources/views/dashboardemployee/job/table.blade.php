...
@section('title', 'Tabel Job')

@section('content')
<h1 class="mt-3" style="margin-left: 35vw">Data Job</h1>

<div class="container mt-3">
    <div class="bungkus d-flex mb-4">
    <div class="row g-1">
        <a href="{{route('add-job')}}" type="button" class="btn btn-primary ml-3">+ Tambah</a>
        {{-- <div class="dropdown">
                    ...
                    <table class='table table-hover' id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->agent }}</td>
                                <td>
                                    <a href="/job/form-edit/{{ $row->id }}" class="text-warning">
...
<script>
    $('.delete').click(function () {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/job/delete/" + databaseid + ""
