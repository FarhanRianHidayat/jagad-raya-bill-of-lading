...
@section('content')
<h1 class="mt-3" style="margin-left: 35vw">Data Shipper</h1>

<div class="container mt-3">
    <div class="bungkus d-flex mb-4">
    <div class="row g-1">
        <a href="{{route('add-shipper')}}" type="button" class="btn btn-primary ml-3">+ Tambah</a>
        {{-- <div class="dropdown">
                    ...
                    <table class='table table-hover' id="table1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->email }}</td>
                                <td>
                                    <a href="/shipper/form-edit/{{ $row->id }}" class="text-warning">
...
<script>
    $('.delete').click(function () {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = "/shipper/delete/" + databaseid + ""
